...
public:
	...
	HRESULT OLDeleteItems(XUIMessageDeleteItems *pDeleteItemsData, BOOL& bHandled);
	...
	XUI_BEGIN_MSG_MAP()
		...
		XUI_ON_XM_DELETE_ITEMS(OLDeleteItems)
    ...
    XUI_IMPLEMENT_CLASS(OptionList, L"OList", XUI_CLASS_LIST);
};
